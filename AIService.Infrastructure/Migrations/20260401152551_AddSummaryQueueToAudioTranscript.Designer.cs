...
namespace AIService.Infrastructure.Migrations
{
    ...
    [Migration("20260401152551_AddSummaryQueueToAudioTranscript")]
    partial class AddSummaryQueueToAudioTranscript
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AIService.Domain.Entities.AudioTranscript", b =>
                {
                    ...
                    b.Property<string>("SummaryQueueError")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("summary_queue_error");

                    b.Property<int>("SummaryQueueStatus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("summary_queue_status");

                    b.Property<Guid?>("SummaryRequestedBy")
                        .HasColumnType("uuid")
                        .HasColumnName("summary_requested_by");
