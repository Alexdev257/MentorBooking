...
namespace AIService.Infrastructure.Migrations
{
    ...
    [Migration("20260329150954_AddAudioTranscriptZoomSourceRefs")]
    partial class AddAudioTranscriptZoomSourceRefs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AIService.Domain.Entities.AudioTranscript", b =>
                {
                    ...
                    b.Property<Guid?>("SourceMeetingRecordingId")
                        .HasColumnType("uuid")
                        .HasColumnName("source_meeting_recording_id");
